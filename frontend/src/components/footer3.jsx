      ...
      <div className="footer3-max-width thq-section-max-width">
        <div className="footer3-content">
          <div className="footer3-logo">
            ...
            />
            <span className="footer3-text10">
              {props.text ?? (
                <Fragment>
                  <span className="footer3-text19">
                    <span className="footer3-text20">K</span>
                    <span>ULLI</span>
                  </span>
                </Fragment>
              )}
          ...
          <div className="footer3-row">
            <div className="footer3-footer-links">
              ...
              <span className="thq-body-small">
                {props.termsLink ?? (
                  <Fragment>
                    <span className="footer3-text16">Terms of Service</span>
                  </Fragment>
                )}
              </span>
              <span className="thq-body-small">
                {props.cookiesLink ?? (
                  <Fragment>
                    <span className="footer3-text22">Cookies Settings</span>
                  </Fragment>
                )}
              </span>
            </div>
...
Footer3.defaultProps = {
  ...
  termsLink: undefined,
  link4: undefined,
  logoSrc: '/New photos/7952195_delivery_truck_shipping_courier_cargo_icon.svg',
  link5: undefined,
  text: undefined,
