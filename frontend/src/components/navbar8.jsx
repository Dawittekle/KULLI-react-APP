        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            <a href={props.link2Url} className="thq-link thq-body-small">
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar8-text24">Link 2</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link3 ?? (
                <Fragment>
                  <span className="navbar8-text14">Link 3</span>
                </Fragment>
              )}
            </a>
            <div
            ...
            >
              <span className="thq-link thq-body-small">
                {props.link4 ?? (
                  <Fragment>
                    <span className="navbar8-text22">Link 4</span>
                  </Fragment>
                )}
              </span>
          ...
          <div className="navbar8-buttons1">
            <button className="navbar8-action11 thq-button-filled thq-button-animated">
              <span>
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar8-text27">Main Action</span>
                  </Fragment>
                )}
              </span>
            </button>
            <button className="navbar8-action21 thq-button-outline thq-button-animated">
              <span>
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar8-text20">Secondary Action</span>
                  </Fragment>
                )}
              </span>
            </button>
                ...
                <div className="navbar8-menu-item7">
                  ...
                  <div className="navbar8-content7">
                    <span className="navbar8-page32 thq-body-large">
                      {props.page3 ?? (
                        <Fragment>
                          <span className="navbar8-text23">Page Three</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
                ...
                <div className="navbar8-menu-item8">
                  ...
                  <div className="navbar8-content8">
                    <span className="navbar8-page42 thq-body-large">
                      {props.page4 ?? (
                        <Fragment>
                          <span className="navbar8-text15">Page Four</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
